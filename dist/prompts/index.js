    ...
    server.setRequestHandler(GetPromptRequestSchema, async (request) => {
        ...
        switch (name) {
            ...
            case "code_review": {
                ...
                const content = PROMPT_TEMPLATES.codeReview(args.language, args.code);
                return {
                    messages: [
                        { role: "user", content: { type: "text", text: content } },
                    ],
            ...
            case "bug_fix": {
                ...
                const content = PROMPT_TEMPLATES.bugFix(args.description, args.code);
                return {
                    messages: [
                        { role: "user", content: { type: "text", text: content } },
                    ],
            ...
            case "refactor": {
                ...
                const content = PROMPT_TEMPLATES.refactor(args.description, args.code);
                return {
                    messages: [
                        { role: "user", content: { type: "text", text: content } },
                    ],
            ...
            case "generate_tests": {
                ...
                const content = PROMPT_TEMPLATES.generateTests(args.code, args?.framework || "vitest");
                return {
                    messages: [
                        { role: "user", content: { type: "text", text: content } },
                    ],
